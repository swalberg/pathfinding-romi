...
public class DriverAssistTest {
     ...
     * See the `PoseTest.png` for a diagram of the coordinate system and the transformations
     */
    @Test
    public void testFindPoseToLeftOfSeenReef_WhenItIsStraightAhead() {
        // Mock the camera-to-target transform supplier
        Optional<Transform3d> cameraToTargetTransform = Optional.of(new Transform3d(1.0, 0.0, 0.0, new Rotation3d(new Rotation2d(Math.PI))));
        ...
        Pose2d expectedPose = new Pose2d(0.93, 0.15, new Rotation2d()); // Expected pose after transformations
